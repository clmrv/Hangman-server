...
namespace plog
{
    ...
    public:
        ...
        static util::nstring format(const Record& record)
        {
            ...
            ss << std::setfill(PLOG_NSTR(' ')) << std::setw(9) << std::left << severityToStringEmoji(record.getSeverity()) << PLOG_NSTR(" ");
    ...
    class TxtFormatterEmoji : public TxtFormatterEmojiImpl<false> {};
    class TxtFormatterEmojiUtcTime : public TxtFormatterEmojiImpl<true> {};
}
